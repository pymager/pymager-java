...
public class BadUploadRequestException extends ImageServerException {
    private static final long serialVersionUID = 1L;
    
    private ImageId imageId;
    private ImageFormat imageFormat;
    
    public BadUploadRequestException(ImageId imageId, ImageFormat imageFormat, Exception e) {
	super(e);
