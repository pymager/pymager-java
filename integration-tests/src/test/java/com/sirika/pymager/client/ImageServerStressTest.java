...
import static com.sirika.pymager.client.testhelpers.PictureStreamAssertionUtils.is100x100CornicheKabylePicture;
import static com.sirika.pymager.client.testhelpers.PictureStreamAssertionUtils.isCornicheKabylePicture;
import static com.sirika.pymager.client.testhelpers.PictureStreamAssertionUtils.isYemmaGourayaPicture;
import static com.sirika.pymager.client.testhelpers.PictureStreamSourceObjectMother.yemmaGourayaDerived100x100PictureStream;
...
import com.sirika.pymager.client.jobs.DownloadPictureJob;
import com.sirika.pymager.client.jobs.OperationStatus;
import com.sirika.pymager.client.jobs.UploadPictureJob;
import com.sirika.pymager.client.testhelpers.ImageIdObjectMother;
import com.sirika.pymager.client.testhelpers.ImageReferenceObjectMother;
...
public class ImageServerStressTest extends AbstractImageServerIntegrationTestCase {
    ...
    private final static int TOTAL_NUMBER_OF_THREADS = 20;
